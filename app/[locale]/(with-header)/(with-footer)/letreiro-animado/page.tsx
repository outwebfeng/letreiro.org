...
const ROUTE_PATH = '/letreiro-animado';
const METADATA_NAMESPACE = 'Metadata.letreiroAnimado';
const SCOPE = 'Animado';
...
export default async function AnimadoPage({ params: { locale } }: { params: { locale: string } }) {
