...
const ROUTE_PATH = '/letreiro-para-loja';
const METADATA_NAMESPACE = 'Metadata.letreiroParaLoja';
const SCOPE = 'Loja';
...
export default async function LojaPage({ params: { locale } }: { params: { locale: string } }) {
